...
?>
	<div class="php1"> 
		...
		<a href="###"><div class="banngobutton" onclick="eee=1;po_ru_quantity=<?php echo $row[2]; ?>;po_ruku('t2=<?php echo $row[1] ?>&t3=<?php echo $row[2] ?>&t6=<?php echo $row[5] ?>&t7=<?php echo $row[6] ?>&customer_id=<?php echo $row[10] ?>&_id=<?php echo $row[9] ?>&asahipo=<?php echo $row[0] ?>')">入库->完成</div></a><br>
		<br>
