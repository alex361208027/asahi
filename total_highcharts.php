...
<script>
function year(shit){
	shit.href="total_highcharts.php?year="+document.getElementById('year').value;
}
</script>
<body>
<input type="text" value="<?php echo $year; ?>" id="year" style="width:80px;background:none;border:1px solid black;"> <a href="" onclick="year(this)">Go</a>
